...
<script>
    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            refuse:function(){
                 this.$router.push({path:'/opinion',query:{id:this.dataObj.mealApplyId,typeName:'meal',applyType:16,color:'#f80'}})
            },
            ...
            deliverTo(){ //转交
                ...
                this.$router.push({path:'/imchoices',query:{id:this.dataObj.mealApplyId,receiverIds:newCopy,careOf:true,typeName:'meal',applyType:16,bgcolor:'#f80',auditerIds:newApprStr,num:1}})
            },
            approveBack(){ //退回
                 this.$router.push({path:'/approveBack',query:{id:this.dataObj.mealApplyId,typeName:'meal',applyType:16,color:'#f80'}})
            },
            consent:function(type){
                ...
                params={id:this.dataObj.mealApplyId,receiverIds,auditerIds,receiverCompanyId,auditCompanyId,
                color:'#f80',applyType:16,typeName:'meal',pageType:type,careOf:true,num:1}
            ...
            resubmit(){ //再次提交
                this.$router.replace({path:'/meal',query:{mealId:this.dataObj.mealApplyId,resubmit:1}})
            },
            urge(){ //催办
                this.isBackout = false;
                let that = this;
                this.axios.post('/work/audit'+this.Service.queryString({
                    applyId:this.dataObj.mealApplyId,
                    type:6,
                    applyType:16,
                })).then(function(res){
                ...
                this.axios.post('/work/audit'+this.Service.queryString({
                    ...
                    applyType:16,
                        ...
                        if(res.data.h.code!=200){
                            ...
                            setTimeout(()=>{
                                window.location.href = "epipe://?&mark=mealDetails&_id="+that.dataObj.mealApplyId+'&data='+JSON.stringify({text:1});;
                            },500)     
                        } 
                    })
            },
