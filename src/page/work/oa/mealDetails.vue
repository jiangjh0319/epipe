...
<script>
    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            ...
            this.$router.push({path:'/opinion',query:{id:this.dataObj.mealApplyId,receiverIds:copyStr,auditerIds:apprStr,color:'#f80',typeName:'meal',applyType:16,pageType:'consent'}})
