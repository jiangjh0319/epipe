...
<script>
    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            refuse:function(){
                 this.$router.push({path:'/opinion',query:{id:this.dataObj.borrowApplyId,typeName:'borrow',applyType:9,color:'#0fc37c'}})
            },
            ...
            deliverTo(){ //转交
                ...
                this.$router.push({path:'/imchoices',query:{id:this.dataObj.borrowApplyId,receiverIds:newCopy,careOf:true,typeName:'borrow',applyType:9,bgcolor:'#0fc37c',auditerIds:newApprStr,num:1}})
            },
            approveBack(){ //退回
            ...
            resubmit(){ //再次提交
                this.$router.replace({path:'/borrow',query:{borrowId:this.dataObj.borrowApplyId,resubmit:1}})
            }, 
            print(){//打印
                ...
                this.axios.post('/work/audit'+this.Service.queryString({
                    ...
                    applyType:7,
                        ...
                        if(res.data.h.code!=200){
                            ...
                            setTimeout(()=>{
                                window.location.href = "epipe://?&mark=borrowDetails&_id="+that.dataObj.borrowApplyId+'&data='+JSON.stringify({text:1});;
                            },500)     
                        } 
                    })
            },
        ...
        mounted:function(){
            ...
            this.axios.get('/work/borrow/info?borrowApplyId='+this.borrowId+'&pushId='+pushId).then(function(res){
