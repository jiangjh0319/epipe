...
<script>
    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            ...
            this.$router.push({path:'/opinion',query:{id:this.dataObj.projectApplyId,receiverIds:copyStr,auditerIds:apprStr,color:'#0fc37c',typeName:'project',applyType:14,pageType:'consent'}})
        ...
        mounted:function(){
            ...
            this.axios.get('/work/project/info?projectApplyId='+this.projectId+'&pushId='+pusthId).then(function(res){
