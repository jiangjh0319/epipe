<template>
    <section class="reimburse">
        ...
        <div class="content">
            <div class="styles">
                <div class="content_head">
                    ...
                    <div>
                        ...
                        <p class="res" v-if="(leaveType==3||leaveType==4)&dataObj.auditStatus!=2">等待{{dataObj.auditUserName}}的{{dataObj | awaits}}</p>
            ...
            <div class="styles infor" v-for="item in dataObj.absenceList" :key="item.id">
                <div class="infor-box">
...
<script>
    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            refuse:function(){
                 this.$router.push({path:'/opinion',query:{id:this.dataObj.absenceApplyId,typeName:'absence',applyType:11,color:'#f80'}})
            },
                ...
                this.axios.post('/work/audit'+this.Service.queryString({
                    ...
                    applyType:11,
                        ...
                        if(res.data.h.code!=200){
                            ...
                            setTimeout(()=>{
                                window.location.href = "epipe://?&mark=absenceDetails&_id="+that.dataObj.absenceApplyId+'&data='+JSON.stringify({text:1});;
                            },500)     
                        } 
                    })
            },
        ...
        mounted:function(){
            ...
            let that = this;
            this.absenceId = this.$route.query.absenceId;
            let pushId = this.$route.query.pushId
            this.axios.get('/work/absence/info?absenceApplyId='+this.absenceId+'&pushId='+pushId).then(function(res){
                that.dataObj = res.data.b;
                that.accessory = that.accessoryFors(that.dataObj.accessory)
                that.title = that.dataObj.username+'的补卡申请'
