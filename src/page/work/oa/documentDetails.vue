    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            ...
            consent:function(type){
                ...
                params={id:this.dataObj.documentApplyId,receiverIds,auditerIds,receiverCompanyId,auditCompanyId,
                color:'#609ef7',applyType:17,typeName:'document',pageType:type,careOf:true,num:1}
        ...
        mounted:function(){
            ...
            this.axios.get('/work/document/info?documentApplyId='+this.documentId+'&pushId='+pusthId).then((res)=>{
