...
<script>
    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            ...
            this.$router.push({path:'/opinion',query:{id:this.dataObj.regularApplyId,receiverIds:copyStr,auditerIds:apprStr,color:'#609df6',typeName:'regular',applyType:15,pageType:'consent'}})
