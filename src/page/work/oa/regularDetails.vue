...
<script>
    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            refuse:function(){
                 this.$router.push({path:'/opinion',query:{id:this.dataObj.regularApplyId,typeName:'regular',applyType:15,color:'#609df6'}})
            },
            ...
            deliverTo(){ //转交
                ...
                this.$router.push({path:'/imchoices',query:{id:this.dataObj.regularApplyId,receiverIds:newCopy,careOf:true,typeName:'regular',applyType:15,bgcolor:'#609df6',auditerIds:newApprStr,num:1}})
            },
            approveBack(){ //退回
                 this.$router.push({path:'/approveBack',query:{id:this.dataObj.regularApplyId,typeName:'regular',applyType:15,color:'#609df6'}})
            },
            consent:function(type){
                ...
                params={id:this.dataObj.regularApplyId,receiverIds,auditerIds,receiverCompanyId,auditCompanyId,
                color:'#609df6',applyType:15,typeName:'regular',pageType:type,careOf:true,num:1}
            ...
            resubmit(){ //再次提交
                this.$router.replace({path:'/regular',query:{regularId:this.dataObj.regularApplyId,resubmit:1}})
            },
            urge(){ //催办
                this.isBackout = false;
                let that = this;
                this.axios.post('/work/audit'+this.Service.queryString({
                    applyId:this.dataObj.regularApplyId,
                    type:6,
                    applyType:15,
                })).then(function(res){
                ...
                this.axios.post('/work/audit'+this.Service.queryString({
                    ...
                    applyType:15,
                        ...
                        if(res.data.h.code!=200){
                            ...
                            setTimeout(()=>{
                                window.location.href = "epipe://?&mark=regularDetails&_id="+that.dataObj.regularApplyId+'&data='+JSON.stringify({text:1});;
                            },500)     
                        } 
                    })
            },
        ...
        mounted:function(){
            ...
            this.axios.get('/work/regular/info?regularApplyId='+this.regularId+'&pushId='+pusthId).then(function(res){
