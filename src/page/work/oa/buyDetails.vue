        ...
        ...mapMutations(['change_man','approver_man']),
            ...
            consent:function(type){
                let that = this,receiverIds='',auditerIds='',receiverCompanyId="",auditCompanyId="",url='',params={};
                 ...
                 params={id:this.dataObj.userBuyId,receiverIds,auditerIds,receiverCompanyId,auditCompanyId,
                 color:'#0fc37c',applyType:20,typeName:'buy',pageType:type,careOf:true,num:1}
