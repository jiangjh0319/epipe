        ...
        <div class="content">
            ...
            <div class="styles infor">
                ...
                <div class="infor-box">
                    ...
                    <p>{{dataObj.applyName}}</p>
                </div>
                <div class="infor-box">
                    <span>部&emsp;&emsp;门</span>
                    <p>{{dataObj.applyDept}}</p>
                </div>
                <div class="infor-box">
            ...
            <div class="styles infor">
                <div class="infor-box">
                    <span>异动原因 </span>
                    <p>{{dataObj.moveReason}} </p>
                </div>
                 <div class="infor-box">
                    <span>异动类型 </span>
                    <p>{{dataObj.moveType}} </p>
                </div>
                 <div class="infor-box">
                    <span>需申请权限 </span>
                    <p>{{dataObj.wantPri}} </p>
    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            ...
            consent:function(type){
                ...
                params={id:this.dataObj.erpprimoveApplyId,receiverIds,auditerIds,receiverCompanyId,auditCompanyId,
                color:'#f80',applyType:22,typeName:'erpPermission',pageType:type,careOf:true,num:1}
            ...
            resubmit(){ //再次提交
                this.$router.replace({path:'/erpPermission',query:{erpPermissionId:this.dataObj.erpprimoveApplyId,resubmit:1}})
            },
            urge(){ //催办
                ...
                this.axios.post('/work/audit'+this.Service.queryString({
                    ...
                    applyType:22,
                        ...
                        if(res.data.h.code!=200){
                            ...
                            setTimeout(()=>{
                                console.log(window.location.href = "epipe://?&mark=erpPermissionDetails&_id="+that.dataObj.erpprimoveApplyId+'&data='+JSON.stringify({text:1}))
                                window.location.href = "epipe://?&mark=erpPermissionDetails&_id="+that.dataObj.erpprimoveApplyId+'&data='+JSON.stringify({text:1});
                            },500)     
                        } 
                    })
            },
        ...
        mounted:function(){
            ...
            let that = this;
            this.erpPermissionId = this.$route.query.erpPermissionId;
            let pusthId = this.$route.query.pushId
            this.axios.get('/move/erpprimove/info?erpprimoveApplyId='+this.erpPermissionId+'&pushId='+pusthId).then((res)=>{
