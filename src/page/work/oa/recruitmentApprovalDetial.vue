...
<script>
    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            refuse:function(){
                 this.$router.push({path:'/opinion',query:{id:this.dataObj.interviewApplyId,typeName:'recruitmentApproval',applyType:23,color:'#0fc37c'}})
            },
            ...
            deliverTo(){ //转交
                ...
                this.$router.push({path:'/imchoices',query:{id:this.dataObj.interviewApplyId,receiverIds:newCopy,careOf:true,typeName:'recruitmentApproval',applyType:23,bgcolor:'#0fc37c',auditerIds:newApprStr,num:1}})
            },
            approveBack(){ //退回
                 this.$router.push({path:'/approveBack',query:{id:this.dataObj.interviewApplyId,typeName:'recruitmentApproval',applyType:23,color:'#0fc37c'}})
            },
            consent:function(type){
                ...
                color:'#0fc37c',applyType:23,typeName:'recruitmentApproval',pageType:type,careOf:true,num:1}
