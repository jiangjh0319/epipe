            ...
            consent:function(){
              let that = this;
               ...
               let apprStr = this.appAndCopy(this.newAppr,'auditUserId')
                this.$router.push({path:'/opinion',query:{id:this.dataObj.receptionApplyId,receiverIds:copyStr,auditerIds:apprStr,color:'#fd545c',typeName:'reception',applyType:10,pageType:'consent'}})
            },
            print(){//打印
