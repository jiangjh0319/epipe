        ...
        <div class="content">
            <div class="styles input_group">
                <div class="bor_bottom">
                    <span class="title">借阅编号</span>
                    <input placeholder="请输入借阅编号" disabled  v-model="archivesNo" />
                </div>
                 <div class="bor_bottom">
                    <span class="title">借阅申请人</span>
                    <input placeholder="请输入借阅申请人" disabled  v-model="name" />
                </div>
                 <div class="bor_bottom">
                    <span class="title">所属部门</span>
                    <input placeholder="请输入所属部门" disabled  v-model="department" />
                </div>
            </div>

            <div class="styles input_group">
                <div class="bor_bottom">
                    <span class="title">借阅名称</span>
                    <input placeholder="请输入借阅名称" disabled  v-model="borrowName" />
                </div>
                 <div class="bor_bottom">
                    <span class="title">预计归还日期</span>
                    <input placeholder="请选择日期" disabled  v-model="borrowDate" />
                </div>
                 <div class="bor_bottom">
                    <span class="title">借阅原因</span>
                    <input placeholder="请输入借阅原因" disabled  v-model="borrowReason" />
                </div>
            </div>
            ...
            <div class="styles input_group" v-for="(item,index) in material" :key="item.id">
                <div class="control" >
                    ...
                    <span style="color:#fd545c" v-show="material.length>1" @click.stop="remove(index)">删除</span>
                </div>
                <div class="bor_bottom">
                ...
                <div class="">
                    ...
                    <input disabled  v-model="item.materialName" />
    ...
    if(that.materialReceiveTheme==''){
        ...
        let  appObj = that.Util.approverFormat(that.allApprovers,that.linkAuditNum)
         ...
         params = {
            ...
            "dossierBorrowNoDm":"yyyydeceshi", //档案编号
            "dossierBorrowNo":that.archivesNo,//借阅编号
            "borrowName":"yyyyy",//借阅名称
            "borrowDate":"2020-06-05",//归还日期
            "borrowReason":"yyqweiqwiouqwor",//借阅原因
            "dossier":that.dossier,//档案名称
            "receiveId":"281fbd4c0d4740d1b5f1e976eea116d6",
            "receiveCompany":"qianhaiyouguan",
            "receiveOffice":"yanfa",
            "handleUserId":that.handleUserId,//档案管理员ID
            "handleUser":that.handleUser,//档案管理员
            "dossierId":that.dossierId,//档案ID
            
            "oldDossierLocationId":that.oldDossierLocationId,//档案存放位置ID
            "oldDossierLocation":that.oldDossierLocation,//档案存放位置
