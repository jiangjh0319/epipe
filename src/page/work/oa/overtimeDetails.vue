...
<script>
    ...
    export default {
        ...
        ...mapMutations(['change_man','approver_man']),
            ...
            this.$router.push({path:'/opinion',query:{id:this.dataObj.overTimeApplyId,receiverIds:copyStr,auditerIds:apprStr,color:'#fd545c',typeName:'overtime',applyType:18,pageType:'consent'}})
