            ...
            consent:function(){
              let that = this;
               ...
               let apprStr = this.appAndCopy(this.newAppr,'auditUserId')
                this.$router.push({path:'/opinion',query:{id:this.dataObj.materialReceiveId,receiverIds:copyStr,auditerIds:apprStr,color:'#f80',typeName:'material',applyType:21,pageType:'consent'}})
            },
            resubmit(){ //再次提交
