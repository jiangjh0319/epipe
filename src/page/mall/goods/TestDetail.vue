<template>
  <div>
    ...
    <calendar v-model="demo1.calendarShow" :default-date="demo1.defaultDate" @change="demo1DateChange" :min-date="demo4.minDate">
    </calendar>
    <p>DEMO2：多语言-英语</p>
    ...
    <p class="detail">
      只能选择当天及以后30天内{{ demo3.selectedDate }}
    </p>
	  ...
	  data:function() {
		  return {
			  demo1: {
				  ...
				  minDate: new Date(),
				  selectedDate: this.dateFormat(new Date(), "yyyy-MM-dd")
			  },
			  demo2: {
				  calendarShow: false,
