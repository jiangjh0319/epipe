    ...
    <div>
        <div class="styles input_group " ref="templates">
                ...
                <div class="items leaveTime bor_bottom">
                    金额 <span style="font-size:0.12rem;color:#999"></span>
                    <p>
                        <input type="number" maxlength="8" placeholder="请输入金额" v-model="datas.reimburseAmount">
                ...
                <div class="items bor_bottom" @click="getTime()" >
                    ...
                    <p style="text-align:right">
                        <span class="nullValue omit">{{datas.reimburseDate}}</span>
                        <svg class="icon icon-back" aria-hidden="false">
                            <use xlink:href="#icon-right"></use>
                        </svg>
                    </p>
                </div>
                <router-link :to="{ path:'/reimburseType', query: {indexs:index,type:'reimburse',color:'#0fc37c'}}" class="items bor_bottom"  tag="div">
                    报销类别
                    <p style="text-align:right">
                        <span class="nullValue omit" v-text="typeName?typeName:'请选择报销类型'"></span>
                        <svg class="icon icon-back" aria-hidden="false">
                            <use xlink:href="#icon-right"></use>
                        </svg>
                    </p>
                ...
                <div class="items items-details bor_bottom"  >
                    费用明细
                    <textarea placeholder="请输入费用明细描述" v-model="datas.reimburseDesc"></textarea>
                </div>
            </div>
    </div>
</template>
...
<script>
    export default {
        ...
        props: ["datas",'index','typeName','length'],
        created() {
         },
        methods:{
             getTime(){ //获取原生时间
                ...
                window["epipe_leavetime_callback"] = str => {
                    ...
                    that.datas.reimburseDate = flag?str[0]+'-'+str[1]+'-'+str[2]+' '+str[3]+':'+str[4]:str; 
                }
            },
